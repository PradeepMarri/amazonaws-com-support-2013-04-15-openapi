...
func RefreshtrustedadvisorcheckHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RefreshTrustedAdvisorCheckRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.RefreshTrustedAdvisorCheck", cfg.BaseURL)
		...
		var result models.RefreshTrustedAdvisorCheckResponse
...
func CreateRefreshtrustedadvisorcheckTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    RefreshtrustedadvisorcheckHandler(cfg),
	}
}
