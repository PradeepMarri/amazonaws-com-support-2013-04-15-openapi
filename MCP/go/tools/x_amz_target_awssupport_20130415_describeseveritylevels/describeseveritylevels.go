...
func DescribeseveritylevelsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeSeverityLevelsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.DescribeSeverityLevels", cfg.BaseURL)
		...
		var result models.DescribeSeverityLevelsResponse
...
func CreateDescribeseveritylevelsTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeseveritylevelsHandler(cfg),
	}
}
