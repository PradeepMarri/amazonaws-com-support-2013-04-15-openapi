...
func DescribetrustedadvisorcheckrefreshstatusesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeTrustedAdvisorCheckRefreshStatusesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorCheckRefreshStatuses", cfg.BaseURL)
		...
		var result models.DescribeTrustedAdvisorCheckRefreshStatusesResponse
...
func CreateDescribetrustedadvisorcheckrefreshstatusesTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribetrustedadvisorcheckrefreshstatusesHandler(cfg),
	}
}
