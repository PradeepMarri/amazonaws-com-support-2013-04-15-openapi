...
func AddcommunicationtocaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AddCommunicationToCaseRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.AddCommunicationToCase", cfg.BaseURL)
		...
		var result models.AddCommunicationToCaseResponse
...
func CreateAddcommunicationtocaseTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    AddcommunicationtocaseHandler(cfg),
	}
}
