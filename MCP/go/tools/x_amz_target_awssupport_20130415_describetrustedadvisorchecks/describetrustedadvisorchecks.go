...
func DescribetrustedadvisorchecksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeTrustedAdvisorChecksRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.DescribeTrustedAdvisorChecks", cfg.BaseURL)
		...
		var result models.DescribeTrustedAdvisorChecksResponse
...
func CreateDescribetrustedadvisorchecksTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribetrustedadvisorchecksHandler(cfg),
	}
}
