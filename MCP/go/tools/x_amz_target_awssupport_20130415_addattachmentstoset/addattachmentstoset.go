...
func AddattachmentstosetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AddAttachmentsToSetRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AWSSupport_20130415.AddAttachmentsToSet", cfg.BaseURL)
		...
		var result models.AddAttachmentsToSetResponse
